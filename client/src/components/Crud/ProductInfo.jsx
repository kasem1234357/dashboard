  ...
  return (
    <form className='ProductInfo flex'>
      ...
      <div className="ProductInfo--box ProductInfo__copon flex">
        ...
        <div className="ProductInfo--input flex">
          <input type="text" placeholder='put your copon code' defaultValue={data.coupon || ''} onInput={(e)=>updateData('coupon',e.target.value)}/>
      ...
      <button className='controlls--save' onClick={(e)=>save(e)}><p>Add</p></button>
    </form>
  )
}

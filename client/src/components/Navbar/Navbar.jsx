  ...
  return (
    <div className={`navbar ${close?'hide--navbar':''}`}>
      ...
      <div className="navbar__list">
        <ul>
          <NavLink className={({isActive})=>isActive ? 'list--active' : undefined} to='/'><span >Dashboard</span></NavLink>
          <NavLink className={({isActive})=>isActive ? 'list--active' : undefined} to='/massage'><span>Massege</span></NavLink>
          <NavLink className={({isActive})=>isActive ? 'list--active' : undefined} to='/crud'><span >CRUD</span></NavLink>
          ...
          <NavLink className={({isActive})=>isActive ? 'list--active' : undefined} to='/contact'><span>Contact</span></NavLink>
          <NavLink className={({isActive})=>isActive ? 'list--active' : undefined} to='/settings'><span>Settings</span></NavLink>
        </ul>
      </div>
      </div>
  )
